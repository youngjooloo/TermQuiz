			...
			<form action="mjoin" method="POST" class="appointment-form"
				...
				<div class="form-group-1">
					...
					<input
						...
						autoComplete="off" /> 
					<input type="text" class="joininput"
					...
					<div id="socialnf">
						<input type="number" class="joininput" oninput="numcheck(this);"
							name="scNumF" id="socialnumf" maxlength="6" minlength="6"
				...
				<div class="form-check">
					...
					<label for="agree-term" class="label-agree-term">
						<span><span></span></span>I agree to the 
						<a href="#" class="term-service">Terms and Conditions</a>
					</label>
					<p id="agreecheck"></p>
				</div>
				<div class="form-submit">
					<button type="button" class="submitBtn submit_Confirm2" >Sign Up</button>
